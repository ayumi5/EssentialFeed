...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_loadMoreActions_requestMoreFromLoader() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(loader.loadMoreCallCount, 3, "Expected no request while loading all pages")
    }
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        sut.simulateUserInitiatedReload()
        XCTAssertTrue(sut.isShowingLoadingIndicator, "Expected loading indicator once initiates a reload")
    ...
    func test_loadMoreCompletion_rendersErrorMessageOnError() {
        ...
        sut.simulateLoadMoreFeedAction()
        XCTAssertEqual(sut.loadFeedMoreErrorMessage, nil)
        
        loader.completeLoadMoreWithError()
        XCTAssertEqual(sut.loadFeedMoreErrorMessage, loadError)
    ...
    func test_feedImageView_doesNotLoadImageAgainUntilPreviousRequestCompletes() {
        ...
        sut.simulateFeedImageViewNotVisible(at: 0)
        sut.simulateFeedImageViewVisible(at: 0)
        XCTAssertEqual(loader.loadedImageURLs, [image.imageURL, image.imageURL, image.imageURL], "Expected third request when visible after canceling previous requelst")
    }
